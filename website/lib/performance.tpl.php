...
<?
if (sizeof($Special)>0){ 
   printf('<tr><th colspan="7"><a href="%splay.php#alternative" name="alt" title="wrong algorithm, or something else that makes the programs less comparable">"wrong" (different) algorithm, or&#8230;</a></th></tr>', CORE_SITE);
