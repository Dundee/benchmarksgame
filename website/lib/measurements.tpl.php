...
<p>This table shows 4 <em>measurements</em> - <a href="<?=CORE_SITE;?>play.php#time" title="? Help">CPU&nbsp;Time</a>, <a href="<?=CORE_SITE;?>play.php#time" title="? Help">Elapsed&nbsp;Time</a>, <a href="<?=CORE_SITE;?>play.php#memory" title="? Help">Memory</a> and <a href="<?=CORE_SITE;?>play.php#gzbytes" title="? Help">Code</a>.</p>

<p>Each row shows those measurements for a particular <?=$LangName;?> program with a particular <a href="<?=CORE_SITE;?>play.php#inputvalue" title="? Help">command-line input value N</a>.</p>
