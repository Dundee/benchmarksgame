...
<p>You can no longer find the Benchmarks Game with Google or any other search engine. So, if you're interested in programming language comparisons and performance benchmarks, <a href="https://pybenchmarks.org/">bookmark the website now!</a></p>

<p>Since 2004, The Python Interpreters Benchmarks has been hosted by <a href="https://wiki.debian.org/Alioth">Alioth</a>, and the <a href="https://wiki.debian.org/Alioth/Web">web hosting</a> has mostly worked well enough for a low volume web site.</p>
