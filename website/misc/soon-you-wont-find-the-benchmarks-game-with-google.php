...
<p>As a matter of policy, the Alioth admins have now <b>throttled web crawling</b> to reduce average server load from 30% to near nothing. There's been no suggestion that the benchmarks game website was the primary cause of that server load. It just seems to be the result of the default configuration used to provide dynamic content for 1,000 projects.</p>
...
<p>The inevitable consequence is that pages Googlebot cannot access are removed from Google's index. That's been happening all year. Since mid-September the benchmarks game has rapidly been removed from Google's index. <b>Soon you won't find the Benchmarks Game website with Google or any other search engine, because the Alioth admins have throttled web crawling.</b></p>
