...
$langs = array(
   array('python3','Python 3.7.4 (with NumPy and gmpy2)','python3',$allsites),
   ...
   array('cython','Cython 0.29.13 (with NumPy and gmpy)','cython',$allsites),
   ...
   array('graal','Graal python 19.2.0','graal',$allsites),
   );
