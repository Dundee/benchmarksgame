...
$langs = array(
   ...
   array('pypy','PyPy 2.6.1','pypy',$allsites),
   array('python3','Python 3.4.3','python3',$allsites),
   array('python35','Python 3.5.0','python35',$allsites),
   ...
   array('cython','Cython 0.23.2','cython',$allsites),
   array('nuitka','Nuitka 0.5.14','nuitka',$allsites),
