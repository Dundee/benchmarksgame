...
$langs = array(
   ...
   array('pypy','PyPy 7.1.0 (with gmpy_cffi)','pypy',$allsites),
   ...
   array('cython','Cython 0.29.6 (with NumPy and gmpy)','cython',$allsites),
   ...
   array('graal','Graal python 1.0.0_rc14','graal',$allsites),
   );
