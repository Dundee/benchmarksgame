...
$langs = array(
   ...
   array('cython','Cython 0.28.3 (with NumPy and gmpy)','cython',$allsites),
   array('nuitka','Nuitka 0.5.30','nuitka',$allsites),
   ...
   array('graal','Graal python 1.0.0_rc2','graal',$allsites),
   );
