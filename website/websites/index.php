...
$langs = array(
   ...
   array('python-dev','Python 3.10.0a0','python-dev',$allsites),
   array('pypy3','PyPy3 7.3.4 (with gmpy_cffi)','pypy3',$allsites),
   array('pypy','PyPy 7.3.4 (with gmpy_cffi)','pypy',$allsites),
